...
if (isset($_POST['simpan'])) {
    ...
    $cekNama = mysqli_query($conn, "SELECT * FROM kuliner WHERE nama = '$nama'");
    if (mysqli_num_rows($cekNama) > 0) {
        echo "<script>
                alert('Nama\"$nama\" sudah ada, silakan gunakan nama lain!');
                window.location = 'tambah_kuliner.php';
              </script>";
        exit;
    }

    $query = "INSERT INTO kuliner (nama, deskripsi, gambar) VALUES ('$nama', '$deskripsi', '$gambar')";
